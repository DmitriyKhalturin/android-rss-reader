...
import com.khalturin.dmitriy.rssreader.view.viewmodel.bookmark.FeedViewModel;
...
//==================================================================================================
  ...
  private RecyclerManager getRecyclerManager(){
    ...
    BindingRecyclerAdapter<FeedViewModel> adapter =
      new BindingRecyclerAdapter(R.layout.card_view_bookmark, null, BR.feedViewModel);
